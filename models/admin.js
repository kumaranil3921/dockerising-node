...
const Admins = new Schema({
  name: {
    type: String, trim: true, index: true, default: null, sparse: true,
  },
  email: {
  ...
  phoneNo: {
    type: String, required: true, trim: true, index: true, min: 5, max: 15, sparse: true,
  },
  countryCode: {
    type: String, trim: true, min: 2, max: 5, sparse: true,
  },
